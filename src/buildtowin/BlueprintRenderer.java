...
public class BlueprintRenderer extends RenderBlocks implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int par2, int par3, int par4, Block block, int modelId, RenderBlocks renderer) {
        ...
        if (fakeBlock != null) {
            ...
            ((FakeWorld) this.blockAccess).overrideSurroundingBlueprints(par2, par3, par4);
            fakeBlock.setBlockBoundsBasedOnState(this.blockAccess, par2, par3, par4);
            this.setRenderBoundsFromBlock(fakeBlock);
    ...
    public boolean renderStandardBlock(Block block, int x, int y, int z) {
        ...
        if (block.shouldSideBeRendered(this.blockAccess, x, y - 1, z, 0)) {
            tessellator.setBrightness(this.renderMinY > 0.0D ? 0 : block.getMixedBrightnessForBlock(this.blockAccess, x, y - 1, z));
        ...
        if (block.shouldSideBeRendered(this.blockAccess, x, y + 1, z, 1)) {
            tessellator.setBrightness(this.renderMaxY < 1.0D ? 0 : block.getMixedBrightnessForBlock(this.blockAccess, x, y + 1, z));
            tessellator.setColorRGBA_F(this.red, this.green, this.blue, this.alpha);
        ...
        if (block.shouldSideBeRendered(this.blockAccess, x, y, z - 1, 2)) {
            tessellator.setBrightness(this.renderMinZ > 0.0D ? 0 : block.getMixedBrightnessForBlock(this.blockAccess, x, y, z - 1));
            tessellator.setColorRGBA_F(this.red, this.green, this.blue, this.alpha);
        ...
        if (block.shouldSideBeRendered(this.blockAccess, x, y, z + 1, 3)) {
            tessellator.setBrightness(this.renderMaxZ < 1.0D ? 0 : block.getMixedBrightnessForBlock(this.blockAccess, x, y, z + 1));
            tessellator.setColorRGBA_F(this.red, this.green, this.blue, this.alpha);
        ...
        if (block.shouldSideBeRendered(this.blockAccess, x - 1, y, z, 4)) {
            tessellator.setBrightness(this.renderMinX > 0.0D ? 0 : block.getMixedBrightnessForBlock(this.blockAccess, x - 1, y, z));
            tessellator.setColorRGBA_F(this.red, this.green, this.blue, this.alpha);
        ...
        if (block.shouldSideBeRendered(this.blockAccess, x + 1, y, z, 5)) {
            tessellator.setBrightness(this.renderMaxX < 1.0D ? 0 : block.getMixedBrightnessForBlock(this.blockAccess, x + 1, y, z));
            tessellator.setColorRGBA_F(this.red, this.green, this.blue, this.alpha);
