...
public class GuiScreenProtector extends GuiScreen {
    ...
    public void initGui() {
        ...
        GuiButton decreaseRadius = new GuiButton(1, this.width / 2 - 36, this.height / 2 - 27, 20, 20, "-");
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.fontRenderer.drawString("Protector", this.width / 2 - 10, this.height / 2 - 62, 4210752);
        
        this.fontRenderer.drawString("Protection radius:", (this.width - this.fontRenderer.getStringWidth("Protection radius:")) / 2, this.height / 2 - 40, 4210752);
        
        String strRadius = ((Integer) this.protector.getRadius()).toString();
        this.fontRenderer.drawString(strRadius, (this.width - this.fontRenderer.getStringWidth(strRadius)) / 2, this.height / 2 - 21, 4210752);
